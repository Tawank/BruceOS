...
static bool selftest__shell_register_probe(void) {
    bruce_result_t result = app_runner__register("shell_test_probe", selftest__shell_probe);
...
bool selftest__run_shell_language_case(void) {
    ...
    bool ok = shell__execute_line(&state, "shell_test_probe 'a b' \"a b\"") == 0 &&
...
bool selftest__run_shell_script_case(void) {
    ...
    const char script[] = "SCRIPT_VALUE=across-lines\n# retained state\nshell_test_probe $SCRIPT_VALUE across-lines\n";
