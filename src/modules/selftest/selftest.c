...
#define RUN_SELFTEST(fn)                                                                                     \
    ...
    RUN_SELFTEST(selftest__run_storage_truncate_case);
    ...
    RUN_SELFTEST(selftest__run_manifest_parse_named_icon_case);
    ...
    RUN_SELFTEST(selftest__run_elf_loader_stdio_case);
    ...
    RUN_SELFTEST(selftest__run_elf_loader_socket_case);
    ...
    RUN_SELFTEST(selftest__run_shell_case_case);
    RUN_SELFTEST(selftest__run_shell_glob_case);
    RUN_SELFTEST(selftest__run_shell_brace_case);
    ...
    RUN_SELFTEST(selftest__run_shell_arith_redirect_case);
