...
static const selftest__case_t selftest__cases[] = {
    ...
    SELFTEST_CASE(selftest__run_image_stdin_pipe_case),
    SELFTEST_CASE(selftest__run_image_redraw_on_regain_case),
    ...
    SELFTEST_CASE(selftest__run_shell_pipe_early_exit_case),
    ...
    SELFTEST_CASE(selftest__run_shell_prompt_wrap_scroll_case),
