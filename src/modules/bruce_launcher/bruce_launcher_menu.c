...
static const char *BRUCE_LAUNCHER_DEFAULT_JSON =
    "{\n"
    "  \"WiFi\": {\n"
    "    \"Connect Known Network\": \"wifi\",\n"
    "    \"Enable WiFi\": \"wifi on\",\n"
    "    \"Scan Networks\": \"wifi scan\",\n"
    "    \"Scan Hosts\": \"wifi arp\",\n"
    "    \"Packet Sniffer\": \"wifi sniffer\",\n"
    "    \"TCP Listener\": \"wifi listen\",\n"
    "    \"Disable WiFi\": \"wifi off\"\n"
    "  },\n"
    "  \"WebUI\": \"webui --gui\",\n"
    "  \"Bluetooth\": \"bluetooth --gui\",\n"
    "  \"Bluetooth HID\": \"bluetooth_hid_app --gui\",\n"
    "  \"Infrared\": \"ir --gui\",\n"
    "  \"NRF24\": \"nrf24 --gui\",\n"
    "  \"Files\": \"filemanager --gui\",\n"
    "  \"Terminal\": \"terminal\",\n"
    "  \"TCP Help\": \"tcp help\",\n"
    "  \"Notification Demo\": \"notification push 3000 Bruce notification\",\n"
    "  \"Selftest\": \"selftest\",\n"
    "  \"Apps\": \"/apps\"\n"
    "}\n";
