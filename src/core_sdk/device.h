...
/* Schedules device power-off after delay_ms. Releases a configured power-hold
 * latch, then enters deep sleep. Boards without a latch enter deep sleep
 * directly. Requires the `process` permission. */
